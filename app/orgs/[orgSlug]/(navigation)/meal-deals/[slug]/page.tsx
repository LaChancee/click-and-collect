...
export default async function MealDealDetailPage(props: PageParams<{ orgSlug: string, slug: string }>) {
  ...
  // Fetch the meal deal with its associated items
  ...
  // Serialize the meal deal and articles data
  const serializedMealDeal = serializeData(mealDeal);
    ...
    <Layout>
      <LayoutHeader>
        <div className="flex items-center gap-4">
          ...
          <LayoutTitle>
            Modifier la formule: {mealDeal.name}
          </LayoutTitle>
        </div>
      </LayoutHeader>
      <LayoutContent>
